...
console.log("id")
const{cartList}=this.state
const filteringBased=cartList.filter((each)=>each[0].id!==product[0].id)

console.log(filteringBased)
this.setState({cartList:cartList, filteringBased: filteringBased})
