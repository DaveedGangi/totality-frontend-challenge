...
import {Puffy} from "react-loader-spinner"
...
class Home extends Component {
  ...
  state={storageForRental:[],rentalDataStatus:rentalState.initial,duplicateRentalStorage:[],pageNumber:1,count:0}
  ...
  <div>
    ...
    hello
    <Puffy type="puffy" color="#00BFFF" height={100} width={100}/>
    </div>
