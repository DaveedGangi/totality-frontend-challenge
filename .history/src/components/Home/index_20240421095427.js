    ...
    return(
      ...
      
      {
        duplicateRentalStorage.length===0?<div className="NoDataFound">
          ...
          <img cla src="https://static.vecteezy.com/system/resources/previews/009/674/012/large_2x/no-data-found-concept-illustration-for-websites-landing-pages-mobile-application-banner-and-posters-vector.jpg" alt="rentalNotFound"/></div>:
        <div className="Bg">{
