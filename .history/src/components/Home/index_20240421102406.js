    ...
    return(
      ...
      
      {
        duplicateRentalStorage.length===0?<div className="NoDataFound">
          ental Property are not found R<br/> try other filters
    ...
    return (
     <div>
      ...
      <div className="inputBgSearch">
        <div>
     <input className="searchUser" placeholder="  Search property title" value={text} type="text" onChange={this.changeUserInput} />
