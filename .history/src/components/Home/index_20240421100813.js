...
render(){
  ...
  const{storageForRental,pageNumber,text} = this.state
    ...
    return (
     ...
     <input placeholder="  Search property title" value={text} type="text" onChange={this.changeUserInput} />
      <button clas type="button" onClick={this.searchedInStorage}>Search</button>
