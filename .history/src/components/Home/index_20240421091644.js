    ...
    return (
     ...
     <input value={text} type="text" onChange={this.changeUserInput} />
      ...
      <div>
        ...
        <input onClick={this.priceBelow} type="radio" id="priceBelow3" name="price" value="3"/>
        <label htmlFor="priceBelow3">Below 3 Lakhs</label>
        <br/>
        
        <input onClick={this.priceBelow} type="radio" id="priceBelow5" name="price" value="3"/>
