    ...
    return (
     ...
     <input value={text} type="text" onChange={this.changeUserInput} />
      ...
      <div>
        ...
        <input onClick={this.priceBelow} type="radio" id="priceBelow3" name="price" value="4"/>
        <label htmlFor="priceBelow3">Below 5 Lakhs</label>
        <br/>
        
        <input onClick={this.priceBelow} type="radio" id="priceBelow5" name="price" value="5"/>
        <label htmlFor="priceBelow5">Below 10 Lakhs</label>
