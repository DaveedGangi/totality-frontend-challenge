        ...
        <button className="LogOutButton" type="button" onClick={this.removeCookie}>Log out</button>
                          ...
                          <div>
                            ...
                            <div className="checkOutBg">
                               ...
                               <div className> <h1 className="totalPrice">Total Property Cost: <span style={{color:"green"}}>{Amount} L</span> </h1>
                                <div>{cartList.length===1?<p>{cartList.length} Item in cart</p>:<p>{cartList.length} Items in cart</p>}</div>
                                <div><button className="checkOutButton" type="button">Checkout</button></div>
                                </div>
