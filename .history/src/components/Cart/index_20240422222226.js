                          ...
                          <div>
                            {
                             ...
                             <div>
                              <button className="buttonMinus" id={each[0].id} onClick={decrementCartQuantity} type="button">-</button>&nbsp;{each.quantity}&nbsp;
                              <button className="buttonPlus" id={each[0].id} onClick={incrementCartQuantity} type="button">+</button>
                             </div>
                             <div>
                             <button className="removeButton" id={each[0].id} onClick={removeCartItemBasedOnId} type="button">Remove</button>
                             </div>
                              </div>
                              ))
                              }
