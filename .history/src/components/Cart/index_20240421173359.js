    ...
    render(){
      ...
      <div className="NavBarForRental">
        ...
        <button className="LogOutButton" type="button" onClick={this.removeCookie}>Log out</button>
                          ...
                          <div>
                            {
                              cartList.length===0?<div>Empty
                                <img className="" src="https://th.bing.com/th/id/R.afa6a28d0ee0b5e7d55b7a5aecdfedec?rik=eOl3Z%2bU0XvmYlw&riu=http%3a%2f%2fiticsystem.com%2fimg%2fempty-cart.png&ehk=0omil1zRH7T3Pb5iTzvueamUQLSSb55vgY7dLFF8Bl8%3d&risl=&pid=ImgRaw&r=0&sres=1&sresct=1" alt="emtpy"/>
                              </div>:<div>
                              {cartList.map((each)=>(
