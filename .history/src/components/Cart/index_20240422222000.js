                          ...
                          <div>
                            {
                             ...
                             <div>
                              <button className="cartDecrement" id={each[0].id} onClick={decrementCartQuantity} type="button">-</button>{each.quantity}
                              <button className="cartIncrement" id={each[0].id} onClick={incrementCartQuantity} type="button">+</button>
                             </div>
                             <div>
