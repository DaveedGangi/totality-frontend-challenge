                          ...
                          <div>
                            {
                             ...
                             <div>
                              <button id={each[0].id} onClick={decrementCartQuantity} type="button">-</button>{each.quantity}
                              <button id={each[0].id} onClick={incrementCartQuantity} type="button">+</button>
                             </div>
                             <div>
                            ...
                            <div>
                              {
                                cartList.length===0?null:<div> <h1 className="totalPrice">Total Property Cost: <span style={{color:"green"}}>{Amount} L</span> </h1>
                                <div>{cartList.length===1?<p>{cartList.length} Item in cart</p>:<p>{cartList.length} Items in cart</p>}</div>
                                <div><button className="checkOutButton" type="button">Checkout</button></div></div>
                              }
