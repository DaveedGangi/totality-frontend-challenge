...
class ProductDetails extends Component {
  ...
  successForRental=()=>{
    ...
    <CreateContext.Consumer></CreateContext.Consumer>
      const{quantity,duplicateRentalStorage,storageOfItems}=this.state
    ...
    return(
      ...
      
      {
        duplicateRentalStorage.map((eachRental) =>(
          ...
          <button id={eachRental.id} onClick={this.counting} type="button" className="BookNowButton">ADD TO CART
          </button>
          </div>
          </div>
        ))
