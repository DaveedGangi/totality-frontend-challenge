    ...
    return(
      ...
      
      {
        duplicateRentalStorage.map((eachRental) =>(
          ...
          <button className="btn-btn-primary" onClick={this.onDecrementQuantity} type="button">-</button>
          &nbsp; &nbsp; &nbsp; {quantity} &nbsp; &nbsp; &nbsp;
          <button className="btn-btn-primary" onClick={this.onIncrementQuantity} type="button">+</button>
          </div>
