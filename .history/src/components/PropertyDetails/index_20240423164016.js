    ...
    return(
      ...
      
      {
        duplicateRentalStorage.map((eachRental) =>(
          ...
          <button className="buttonMinus" onClick={this.onDecrementQuantity} type="button">-</button>
          &nbsp; &nbsp; &nbsp; {quantity} &nbsp; &nbsp; &nbsp;
          <button className="buttonPlus" onClick={this.onIncrementQuantity} type="button">+</button>
          </div>
        
          <button  onClick={onClickAddToCart} type="button" className="BookNowButton">ADD TO CART
          </button>
          </div>
          </div>
        ))
...
render(){
  ...
  const{storageForRental,pageNumber,} = this.state
    const jwtToken=Cookies.get("jwt_token");
    console.log(storageForRental)
